...
Sendo o sistema operacional mais utilizado no mundo inteiro, o Android conta com atualizações OTA (over-the-air) tanto para o seu firmware, quanto para suas aplicações. Esta conversa explana os meios em que estas ocorrem, o futuro através desta em prol de um sistema menos fragmentando e as possibilidades de aplicação destas atualizações através do ambiente Android.
...
Será apresentado uma visão geral sobre os conceitos do OpenShift, Containers e arquitetura da plataforma.
